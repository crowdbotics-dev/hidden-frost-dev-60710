"""
Django settings for hidden_frost_dev_60710 project.
...
ROOT_URLCONF = 'hidden_frost_dev_60710.urls'
...
WSGI_APPLICATION = 'hidden_frost_dev_60710.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_frost_dev_60710 API",
    "DESCRIPTION": "API documentation for hidden_frost_dev_60710 App",
    "VERSION": "v1",
}
